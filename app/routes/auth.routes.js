...
app.post('/user/signup',upload.fields(uploadDocs), validateSignupRequest, isRequestValidated,Auth.signup);

app.post('/user/signin',validateSigninRequest, isRequestValidated, Auth.signin);
}